...
from service.FirebaseService import storeDesignToDb, getAllDesigns, deleteDesign, storeToStorage, deleteFromStorageByUrl
...
class TestFirebaseService(unittest.TestCase):
    ...
    def test_deleteFromStorageByUrl(self, mock_storage_bucket):
        ...
        result = deleteFromStorageByUrl(testUrl)
